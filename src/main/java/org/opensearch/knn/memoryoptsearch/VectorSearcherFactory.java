...
public interface VectorSearcherFactory {
     ...
     * @throws IOException
     */
    VectorSearcher createVectorSearcher(Directory directory, String fileName, FlatVectorsReaderWithFieldName flatVectorsReaderWithFieldName) throws IOException;
}
